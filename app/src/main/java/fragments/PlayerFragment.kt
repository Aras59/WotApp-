                                                    ...
                                                    override fun onResponse(call: Call<VehicleStats>, response: Response<VehicleStats>) {
                                                        ...
                                                        if (player != null) {
                                                            ...
                                                            if(wn8<1600.0 && wn8>1399.0){
                                                                playerDataPager.setBackgroundResource(R.color.dark_green)
                                                            ...
                                                            if(wn8<2450.0 && wn8>1999.0){
                                                                playerDataPager.setBackgroundResource(R.color.dark_blue)
                                                            ...
                                                            if(wn8<2850.0 && wn8>2449.0){
                                                                playerDataPager.setBackgroundResource(R.color.purple)
                                                                searchButton.setBackgroundResource(R.color.purple)
                                                                nickLayout.setBackgroundResource(R.color.purple)
                                                            }
                                                            if(wn8>2849.0){
                                                                playerDataPager.setBackgroundResource(R.color.dark_purple)
                                                            ...
                                                            playerDataPager.visibility = View.VISIBLE
                                                            progressBar.visibility = View.INVISIBLE
