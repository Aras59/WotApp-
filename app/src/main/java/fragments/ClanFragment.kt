...
import clans.fragments.ClanDescriptionFragment
import clans.fragments.ClanMembersFragment
import clans.interfaces.ClanDetailsInterface
import clans.interfaces.ClanInterface
import clans.interfaces.ClanRatingsInterface
                        ...
                        clansInterface.enqueue(object : Callback<ClanList> {
                            override fun onResponse(
                                ...
                                if (response != null) {
                                    ...
                                    Toast.makeText(activity, "Clan doesn't exist!", Toast.LENGTH_LONG).show()
                                }
                            }
                            override fun onFailure(call: Call<ClanList>, t: Throwable) {}
                        })
